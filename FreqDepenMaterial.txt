...
# Auxiliary diffrential Method
# Here exp(-dt/tau) aprox= (1 - dt/2*tau)/(1 + dt/2*tau) when dt/2*tau is very small
...
plotting_points = [{'num_steps': 250, 'ex': None, 'scaling_factor': 1,'gb_scaling_factor': 1, 'y_ticks': (0, 0.5, 1),
'y_min': -0.3, 'y_max': 1.2, 'y_text_loc': 0.3, 'label': '(a)', 'label_loc': 0.4},
{'num_steps': 1000, 'ex': None, 'scaling_factor': 1000, 'gb_scaling_factor': 2,                      
 'y_ticks': (-6, -4, -2, 0, 2), 'y_min': -6.2, 'y_max': 2.2, 'y_text_loc': -3, 'label': '(b)', 'label_loc': -1.9}]
...
for subplot_num, plotting_point in enumerate(plotting_points):  
    ...
    plot_e_field(plotting_point['ex'], gbx, plotting_point['num_steps'], plotting_point['scaling_factor'], plotting_point['gb_scaling_factor'], plotting_point['y_ticks'], plotting_point['y_min'],\
                 plotting_point['y_max'], plotting_point['y_text_loc'], plotting_point['label'], plotting_point['label_loc'])
...
def plot_amp(data, gb, freq, label, x_label): # Plot of amplitude at one frequency
    ...
    plt.plot(gb * 1 / gb[120], 'r--', linewidth=2) # The math on gb is just for scaling
...
for subplot_num, plotting_freq in enumerate(plotting_freqs):
    ...
    plot_amp(plotting_freq['amp'], gbx, plotting_freq['freq'], plotting_freq['label'], plotting_freq['x_label'])
